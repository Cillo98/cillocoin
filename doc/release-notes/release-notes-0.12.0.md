...
Then, to tunnel a SSL connection on 25001 to a RPC server bound on localhost on port 18332 do:

    stunnel -d 25001 -r 127.0.0.1:18332 -p stunnel.pem -P ''
...
- #7209 `f3ad812` test: don't override CILLOCOIND and CILLOCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add CILLOCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "CLC" (Ross Nicoll)
