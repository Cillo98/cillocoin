...
This document provides guidelines for internationalization of the Cillocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cillocoin_en.ts` remains unchanged.
