...
* cillocoin.conf: contains configuration settings for cillocoind or cillocoin-qt
* cillocoind.pid: stores the process id of cillocoind while running
...
* debug.log: contains debug information and general logging generated by cillocoind or cillocoin-qt
