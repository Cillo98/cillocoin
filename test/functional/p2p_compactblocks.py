...
# TestNode: A peer we use to send messages to cillocoind, and store responses.
...
class CompactBlocksTest(CillocoinTestFramework):
    ...
    # This test actually causes cillocoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that cillocoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cillocoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # cillocoind will not send blocktxn responses for blocks whose height is
