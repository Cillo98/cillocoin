...
By default, cillocoind will dump mempool on shutdown and
...
class MempoolPersistTest(CillocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give cillocoind a second to reload the mempool
        ...
        self.log.debug("Prevent cillocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
