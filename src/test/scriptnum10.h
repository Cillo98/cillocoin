...
#ifndef CILLOCOIN_TEST_SCRIPTNUM10_H
#define CILLOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Cillocoin Core 0.10.0, for cross-comparison.
 */
public:
