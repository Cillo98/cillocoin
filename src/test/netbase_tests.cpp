...
{
    BOOST_CHECK(TestSplitHost("www.cillocoin.org", "www.cillocoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.cillocoin.org]", "www.cillocoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.cillocoin.org:80", "www.cillocoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.cillocoin.org]:80", "www.cillocoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5002", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5002", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5002", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:5002", "::", 8333));
    BOOST_CHECK(TestSplitHost("::5002", "::8333", -1));
    BOOST_CHECK(TestSplitHost(":5002", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:5002", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5002", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5002", "[::]:8333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
