...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CillocoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_cillocoin-qt -platform xcb      # Linux
//     src/qt/test/test_cillocoin-qt -platform windows  # Windows
//     src/qt/test/test_cillocoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CillocoinUnits::formatWithUnit(unit, balance, false, CillocoinUnits::separatorAlways);
    ...
    // Amount input
    CillocoinAmountField* amountInput = receiveCoinsDialog.findChild<CillocoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: cillocoin:")) != -1);
