...
#ifndef CILLOCOIN_QT_CILLOCOINUNITS_H
#define CILLOCOIN_QT_CILLOCOINUNITS_H
...
/** Cillocoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CillocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CillocoinUnits(QObject *parent);

    /** Cillocoin units.
      @note Source: https://en.cillocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CLC,
...
typedef CillocoinUnits::Unit CillocoinUnit;

#endif // CILLOCOIN_QT_CILLOCOINUNITS_H
