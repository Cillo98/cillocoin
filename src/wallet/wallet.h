...
#ifndef CILLOCOIN_WALLET_WALLET_H
#define CILLOCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this cillocoin node, and set to 0 for transactions that were created
...
#endif // CILLOCOIN_WALLET_WALLET_H
