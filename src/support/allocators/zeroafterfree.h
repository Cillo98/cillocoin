...
#ifndef CILLOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CILLOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CILLOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
