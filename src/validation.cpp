...
const std::string strMessageMagic = "Cillocoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s CLC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("cillocoin-scriptch");
